...
<head>
    ...
    <title>Pixel Photography | About</title>
                        ...
                        <div class="classy-menu">
                            ...
                            <div class="classynav">
                                <ul id="nav">
                                    ...
                                    <li><a href="single-blog.html">Experience</a></li>
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="team-content-area text-center mb-30 wow fadeInUp" data-wow-delay="700ms">
                        <div class="member-thumb">
                            <img src="img/manik.jpg" alt="">
                        </div>
                        <h5>Manik</h5>
                        <span>Photographer</span>
                        <div class="member-social-info">
                            <a href="https://t.me/" target="_blank" style="font-size: 18px; "><i
                                    class="fab fa-telegram" aria-hidden="true"></i></a>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="section-heading text-center">
                        ...
                        <p><a href="https://www.instagram.com/pratistha_aryal/">@pratistha_aryal</a></p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="wrapper">
            <div class="containerUp">
                ...
                <div class="connect">
                    ...
                    <form>
                        <input type="email" placeholder="panthipratistha@gmaiil.com">
